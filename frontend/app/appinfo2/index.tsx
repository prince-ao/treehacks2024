        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: "#FFFFFF" }}>
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={{ justifyContent: 'center', marginTop: 20 }}>
                    <Image source={require('../../assets/images/logo1.png')} style={{ width: width, height: height / 2.5, alignSelf: 'center', resizeMode: 'stretch' }} />
                </View>
                ...
                <View style={{
                    ...
                    {/* <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 20 }}>
                        ...
                        <View style={{ borderColor: "#0077FF", borderWidth: 1, paddingHorizontal: 12, borderRadius: 10, backgroundColor: "#0077aF", paddingVertical: 4, marginHorizontal: 5 }}></View>
